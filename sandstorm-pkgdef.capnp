...
const pkgdef :Spk.PackageDefinition = (
  ...
  manifest = (
    ...
    metadata = (
      icons = (
        appGrid = (svg = embed "meta/icons/spartug-128.svg"),
        grain = (svg = embed "meta/icons/spartug-24.svg"),
        market = (svg = embed "meta/icons/spartug-150.svg"),
      ),

      website = "https://spartug.io",
      codeUrl = "https://github.com/spartug/spartug",
      license = (openSource = mit),
      categories = [productivity, office],

      author = (
        contactEmail = "mquandalle@spartug.io",
