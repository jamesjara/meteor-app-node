...
*/
	  ...
	  onlyShowActivitiesTab() {
		  
	    return Session.get('showActivitiesTab');
	  },
	  
	  onlyShowInformationTab() {
	    return Session.get('showInformationTab');
	  },
	  
	  onlyShowHalloffameTab() {
	    return Session.get('showHalloffameTab');
	  },
  ...
  addCard(evt) { 
    ...
    if (title) {
      ...
      // See https://github.com/spartug/spartug/issues/80
